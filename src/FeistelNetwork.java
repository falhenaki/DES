 ...
 * FeistelNetwork consists of 16 rounds. Each round
...
class FeistelNetwork
{
    ...
    /**
     * The main part of DES encryption In each round, left-half of the input is
     * XORed with the output of the f function, and then the two halves are
     * swapped.
     * 
     * @param input
     *            64-bit output of IP
     * @param subkeys
     *            an array of 16 subkeys
    ...
    /**
     * F function - expands r from 32-bit to 48-bit. The result is XORed with
     * the key. That result is divided into 8 6-bit blocks and fed into 8
     * different substitution boxes that each output 4-bit blocks. The 8 4-bit
     * blocks are combined to be 32-bit and fed into permutation P
     * 
     * @param r
     *            - 32-bit right half of the input used for this round
     * @param key
     *            - 48-bit subkey used for this round
    ...
    /**
     * Expand 32-bit input to 48-bit result using the expansion substitution
     * table
     * 
     * @param r
     *            - right half of the input to expand
    ...
    /**
     * Divide the 48-bit input into 8 6-bit blocks and feed those blocks into 8
     * different substitution boxes that each output 4-bit blocks. The 8 4-bit
     * blocks are combined to be a 32-bit string
     * 
     * @param input
     *            - 48-bit string to feed into the S-boxes
    ...
    /*
     * input is a 6 bit block box is the number of box (0..7) output is in the 6
     * to 4 bits
     */
     ...
     * 
     * @param input
     *            - 32-bit string to feed into the P permutation table
